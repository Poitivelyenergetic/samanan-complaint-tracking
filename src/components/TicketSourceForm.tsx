...
interface TicketSourceFormProps {
  initialValues?: Partial<TicketSourceInput>;
  submitLabel: string;
  submittingLabel: string;
  onSubmit: (values: TicketSourceInput) => Promise<void>;
}

export default function TicketSourceForm({
  initialValues,
  submitLabel,
  submittingLabel,
  onSubmit,
}: TicketSourceFormProps) {
  const t = useTranslations("ticketSources.fields");
