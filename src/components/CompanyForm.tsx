...
const DEFAULT_VALUES: CompanyInput = { number: "", nameAr: "", nameEn: "", managerId: null };

export default function CompanyForm({ staff, initialValues, submitLabel, submittingLabel, onSubmit }: CompanyFormProps) {
  const t = useTranslations("companies.fields");
  const tCommon = useTranslations("common");
  const locale = useLocale();

  const [values, setValues] = useState<CompanyInput>({ ...DEFAULT_VALUES, ...initialValues });
